...
export default function Header({ toggleTheme }: any) {
  ...
  return (
    <div className="navbar bg-background">
      ...
      <label
        className="swap swap-rotate px-5 hover:rotate-12 duration-300"
        onChange={toggleTheme}
      >
        <input type="checkbox" />
        <svg
          className="swap-on fill-text w-6 h-6"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
        >
        ...
        <svg
          className="swap-off fill-text w-6 h-6"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
        >
